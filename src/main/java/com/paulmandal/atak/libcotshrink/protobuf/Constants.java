...
public class Constants {
    public static final double LAT_LON_INT_CONVERSION_FACTOR = 10000000F;
    public static final double HAE_ALT_PRECISION_FACTOR = 10.0;
    public static final double COURSE_PRECISION_FACTOR = 1000.0;
    ...
    public static final double GEOFENCE_BOUNDING_SPHERE_PRECISION_FACTOR = 10.0;
}

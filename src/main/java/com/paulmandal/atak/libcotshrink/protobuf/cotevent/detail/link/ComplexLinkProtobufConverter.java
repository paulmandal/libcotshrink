...
import com.paulmandal.atak.libcotshrink.protobufs.ProtobufComplexLink;
...
public class ComplexLinkProtobufConverter {
    ...
    public ProtobufComplexLink.ComplexLink toComplexLink(CotDetail cotDetail, SubstitutionValues substitutionValues, long startOfYearMs) throws UnknownDetailFieldException, UnhandledInnerTextException, UnhandledChildException {

...
public class HackyTests {
    ...
    public void testPli() {
        ...
        validateLossy(messageType, 193, testXml);
        validateLossless(messageType, 568, testXml);
    ...
    public void testPliWithZeroEndpointAddr() {
        ...
        validateLossy(messageType, 188, testXml);
        validateLossless(messageType, 562, testXml);
        generatePerformanceTableOutput(messageType, testXml);
    }
    ...
    public void testComplexShape() {
        ...
        validateLossy(messageType, 226, testXml);
        validateLossless(messageType, 598, testXml);
        generatePerformanceTableOutput(messageType, testXml);
    }
    ...
    public void testPeerToPeerChat() {
        ...
        validateLossy(messageType, 343, testXml);
        validateLossless(messageType, 665, testXml);
        generatePerformanceTableOutput(messageType, testXml);
    }
    ...
    public void testRoute() {
        ...
        validateLossy(messageType, 887, testXml);
        validateLossless(messageType, 1754, testXml);
        generatePerformanceTableOutput(messageType, testXml);
    }
    ...
    public void testSensor() {
        ...
        validateLossy(messageType, 305, testXml);
        validateLossless(messageType, 859, testXml);
        generatePerformanceTableOutput(messageType, testXml);
    }
    ...
    public void testSimpleShape() {
        ...
        validateLossless(messageType, 680, testXml);
        generatePerformanceTableOutput(messageType, testXml);
    }

    public void testUserIcon() {
        String messageType = "User Icon";
        String testXml = "<?xml version='1.0' encoding='UTF-8' standalone='yes'?><event version='2.0' uid='eaa09ae4-50e0-4052-909a-9a5e3cbe905c' type='a-u-G-E-W' time='2020-08-29T21:26:41.476Z' start='2020-08-29T21:26:41.476Z' stale='2020-08-29T21:31:41.476Z' how='h-g-i-g-o'><point lat='39.73047153452518' lon='-104.97315124278549' hae='1607.5676218634023' ce='9999999.0' le='9999999.0'/><detail><status readiness='true'/><archive/><contact callsign='bombing 1'/><remarks>Lol lol</remarks><archive/><link uid='ANDROID-53af0912586418dc' production_time='2020-08-29T21:26:23.123Z' type='a-f-G-U-C' parent_callsign='dasuberdog' relation='p-p'/><precisionlocation altsrc='DTED2'/><color argb='-1'/><usericon iconsetpath='34ae1613-9645-4222-a9d2-e5f243dea2865/Military/bombing.png'/></detail></event>";
        validateLossy(messageType, 258, testXml);
        validateLossless(messageType, 606, testXml);
        generatePerformanceTableOutput(messageType, testXml);
    }

    public void testWaypoint() {
        String messageType = "Waypoint";
        String testXml = "<?xml version='1.0' encoding='UTF-8' standalone='yes'?><event version='2.0' uid='735fc2c5-2e8a-4e21-b793-a1bfef66fc28' type='b-m-p-w-GOTO' time='2020-08-29T21:22:45.171Z' start='2020-08-29T21:22:45.171Z' stale='2020-08-29T21:27:45.171Z' how='h-g-i-g-o'><point lat='39.72285198329387' lon='-104.99177830439078' hae='1594.3528328257194' ce='9999999.0' le='9999999.0'/><detail><status readiness='true'/><archive/><contact callsign='dasuberdog.29.152230'/><remarks/><archive/><link uid='ANDROID-53af0912586418dc' production_time='2020-08-29T21:22:30.997Z' type='a-f-G-U-C' parent_callsign='dasuberdog' relation='p-p'/><height_unit>4</height_unit><height unit='feet' value='0.0'>0.0</height><precisionlocation altsrc='DTED2'/><color argb='-1'/></detail></event>";
        validateLossy(messageType, 204, testXml);
        validateLossless(messageType, 577, testXml);
        generatePerformanceTableOutput(messageType, testXml);
    }
    ...
    public void testCasevacAllFields() {
        ...
        validateLossy(messageType, 696, testXml);
        validateLossless(messageType, 1476, testXml);
        generatePerformanceTableOutput(messageType, testXml);
    }
    ...
    public void testCasevacNoFields() {
        ...
        validateLossless(messageType, 694, testXml);
        generatePerformanceTableOutput(messageType, testXml);
    }
